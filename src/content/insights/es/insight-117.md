...
| Estado | Nombre de la Presentación | Tarifa | Fecha de Vencimiento | Frecuencia |
|-------|------------|-----|----------|-----------|
...
| Método | Tiempo de Procesamiento | Tarifa de Conveniencia | Mejor Para |
|--------|----------------|-----------------|----------|
...
| Tiempo Después del Plazo | Estado | Consecuencia |
|--------------------|--------|-------------|
...
| Estado | Multa por Demora | Tarifa de Reinstalación | Tiempo Máximo para Reinstalar |
|-------|---------|-------------------|----------------------|
