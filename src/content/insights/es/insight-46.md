...
Holding Principal (País A)
        ↓
Holding Intermedia (País B)
        ↓
Subsidiaria 1 (País C)  →  Operaciones en América Latina
Subsidiaria 2 (País D)  →  Operaciones en Europa
Subsidiaria 3 (País E)  →  Operaciones en Asia
```
...
- Las ganancias de subsidiarias en el extranjero no se gravan hasta que se distribuyen a la holding
- Permite reinvertir utilidades sin costo fiscal inmediato

## 4. Jurisdicciones Populares para Holdings

La elección de la jurisdicción es crítica para una holding internacional:

| Jurisdicción | Ventajas | Consideraciones |
|---|---|---|
