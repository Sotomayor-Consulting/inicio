...
| Plataforma | Integración Stripe | Suscripciones | Comisión Adicional |
|------------|-------------------|---------------|-------------------|
...
# Crear un precio para el curso
price = stripe.Price.create(
  product_data={"name": "Curso de Marketing Digital"},
  unit_amount=49700,  # $497.00 en centavos
  currency="usd",
)
...
```
Tú (Plataforma) ← Stripe ← Alumno
       ↓
Instructor A (recibe 70%)
Instructor B (recibe 70%)
Instructor C (recibe 70%)
```

### Modelos de Pago

| Modelo | Descripción | Comisión Plataforma |
|--------|-------------|-------------------|
...
**Soluciones:**
- Stripe intenta el cobro hasta 3 veces (dunning)
- Enviar email al alumno para actualizar tarjeta
