...
| Aspecto | Factura Nacional | Factura Internacional |
|---------|-----------------|---------------------|
...
| País de origen | Tratamiento Fiscal |
|---------------|-------------------|
...
| Incoterm | Significado | ¿Quién paga el envío? | ¿Quién asume riesgo? |
|----------|-------------|----------------------|---------------------|
...
| Regulación | Aplica a | Obligación |
|-----------|----------|-----------|
...
| Método | Velocidad | Comisión | Cobertura |
|--------|-----------|----------|-----------|
...
```javascript
// Factura recurrente internacional
