...
cardImageAlt: "Tela de aprovação do Stripe com documentos e check verde"
---

Conseguir a aprovação da sua conta Stripe é o primeiro passo para aceitar pagamentos online. No entanto, muitas contas são recusadas ou ficam pendentes por dias ou semanas devido a documentação incorreta, informações inconsistentes ou falta de requisitos.

Neste guia, explicamos **exatamente o que o Stripe precisa para aprovar sua conta em 2026**, com checklist detalhado, documentos aceitos e dicas para evitar recusas.

## 1. O Processo de Aprovação do Stripe

### Etapas da Aprovação

```
Cadastro → Verificação de identidade → Documentação → Análise de risco → Aprovação
    ↓               ↓                      ↓               ↓               ↓
 5 minutos      10-15 minutos         24-72 horas     24-48 horas     1-5 dias
```
...
- CPF/CNPJ ou equivalente fiscal
- Profissão e setor de atuação
- Site ou presença online
...
### Negócios de Baixo Risco (Aprovação Rápida)

**Exemplos:** E-commerce, SaaS, consultoria, educação online, design, desenvolvimento
...
### Negócios de Médio Risco (Revisão Adicional)

**Exemplos:** Viagens, saúde e bem-estar, produtos regulados, serviços financeiros (consultoria)

**Documentação adicional:**
- Tudo do baixo risco +
- Licenças específicas (se aplicável)
- Histórico de transações (se já opera)
- Informações sobre fornecedores

**Prazo estimado:** 3-7 dias

### Negócios de Alto Risco (Análise Manual)

**Exemplos:** Suplementos, CBD (países permitidos), eventos, doações, conteúdo digital adulto (países permitidos)

**Documentação adicional:**
- Tudo do médio risco +
- Certificações específicas
- Comprovante de conformidade regulatória
- Entrevista com equipe do Stripe (possível)
- Histórico de processamento anterior

**Prazo estimado:** 1-4 semanas

> **Nota:** Se você opera em um setor de alto risco, considere plataformas especializadas em vez do Stripe.

## 5. Verificação de Identidade (Stripe Identity)
...
3. **Documento visível** — sem reflexo, cantos aparecendo
4. **Rosto descoberto** — sem óculos escuros, chapéu ou máscara
...
**Problema:** Fotos dos documentos estão borradas, cortadas ou com reflexo.

**Solução:** Use scanner ou tire fotos nítidas. Verifique se o documento não está vencido.

### Motivo 2: Informações Inconsistentes

**Problema:** Nome, endereço ou data de nascimento diferentes entre documentos.

**Solução:** Verifique se TODAS as informações são idênticas em todos os documentos enviados.

### Motivo 3: Site Incompleto ou Inadequado

**Problema:** Site em construção, sem política de privacidade, sem informações de contato.

**Solução:** Complete o site com todas as páginas obrigatórias antes de se registrar.

### Motivo 4: Negócio Não Suportado

**Problema:** Seu tipo de negócio está na lista de negócios proibidos ou restritos.

**Solução:** Verifique a lista de negócios proibidos do Stripe antes de criar a conta.

### Motivo 5: Localização Não Suportada

**Problema:** Seu país não está na lista de países suportados pelo Stripe.

**Solução:** Considere constituir uma empresa em um país suportado (EUA, México, Brasil).
...
- [ ] EIN (se empresa nos EUA)
- [ ] Site completo com políticas
- [ ] Conta bancária no mesmo país
- [ ] Informações consistentes em todos os documentos

### Dicas de Especialistas

1. **Use o mesmo nome em todos os documentos** — RG, passaporte, conta bancária, cadastro
2. **Verifique o endereço** — o comprovante de residência deve ter exatamente o mesmo endereço que você informar no cadastro
3. **Prepare o site antes** — não crie a conta com site "em construção"
4. **Escolha o tipo de negócio correto** — a categoria influencia a análise de risco
5. **Tenha paciência** — não crie múltiplas contas se a primeira for recusada

### O que NÃO Fazer

- ❌ Não crie múltiplas contas — pode ser considerado fraude
- ❌ Não minta sobre seu negócio ou localização — Stripe verifica
- ❌ Não use documentos vencidos
- ❌ Não tente verificar com selfie de outra pessoa
- ❌ Não ignore os e-mails do Stripe durante o processo

## 9. O Que Fazer se sua Conta For Recusada

### Passo 1: Leia o Motivo da Recusa

O Stripe envia um e-mail explicando o motivo. Leia com atenção.
...
- Clique em "Appeal" ou "Contact Support"
- Explique claramente o que corrigiu
- Anexe a documentação atualizada

### Passo 4: Alternativas

Se o Stripe recusar definitivamente:

- **PayPal** — disponível em 200+ países
- **Mercado Pago** — América Latina
- **Square** — EUA, Canadá, Europa
...
- [ ] Verifique se seu país está na lista de suporte do Stripe
- [ ] Se não estiver, decida: LLC nos EUA ou plataforma alternativa
- [ ] Prepare todos os documentos digitalizados
- [ ] Tenha um site completo com políticas

### Durante o Cadastro

- [ ] Preencha os dados exatamente como nos documentos
- [ ] Use o mesmo nome, endereço e data de nascimento
- [ ] Escolha a categoria de negócio correta
- [ ] Complete a verificação de identidade (selfie/vídeo)

### Após o Cadastro

- [ ] Vincule a conta bancária
- [ ] Verifique o e-mail de confirmação
- [ ] Configure 3D Secure
- [ ] Teste transações em modo de teste
- [ ] Aguarde a análise (24-72 horas)

## Conclusão

O **Stripe precisa de documentos corretos, informações consistentes e um site profissional** para aprovar sua conta. A maioria das recusas acontece por erros evitáveis: documentos ilegíveis, dados inconsistentes ou site incompleto.

Prepare tudo com antecedência, siga o checklist e sua conta será aprovada rapidamente. Se precisar de ajuda com a estruturação, conte com a **Sotomayor Consulting International** para assessoria na criação de empresas nos EUA e abertura de contas Stripe.
