...
| Característica | Shopify Payments (Stripe integrado) | Stripe Directo (API) |
|----------------|-------------------------------------|----------------------|
...
| Procesador | Comisión por Transacción | Comisión Shopify Extra | Costo Total (ej: $100) |
|------------|-------------------------|------------------------|------------------------|
